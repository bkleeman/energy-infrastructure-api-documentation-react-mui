                            ...
                            <Paper elevation={12}>
                                <div className="main-paper-content">
                                    ...
                                    <Typography variant='body1' component='body1'>
                                        The US Energy Infrastructure Visualization is a data visualization created by Nathan Matteson and Benjamin Kleeman through the <a href='https://rdcep.org' target='_blank' rel='noreferrer'>Center for Robust Decision Making on Climate and Energy Policy</a> (RDCEP) that documents all long-lived infrastructure (> 20 years service life) associated with extracting, processing, transporting, and converting energy in the U.S.
                                        <br/><br/>
